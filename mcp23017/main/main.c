...
void app_main(void){
    ...
    //mcp23017_set_io_dir(device, 0xff, MCP23017_GPIOA);
    ...
    while (true) {
        ...
        mcp23017_write_io(device, value, MCP23017_GPIOA); //range [0-255]
        printf("GPIOA write = :%d\n", value);
        uint8_t readed = mcp23017_read_io(device, MCP23017_GPIOA);
        if(0b0000010 & 0b0000010){
            printf("ligado\n");
        }else{
            printf("desligado\n");
        }
        ...
        mcp23017_write_io(device, 0b0000000, MCP23017_GPIOA);
